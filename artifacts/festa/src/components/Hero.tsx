    ...
    <section className="festa-paper relative pt-20 pb-10 md:pt-20 md:pb-12 overflow-hidden bg-background lg:min-h-[100dvh] lg:flex lg:items-center">
      ...
      <div className="container relative z-10 px-5 mx-auto max-w-7xl w-full">
        <div className="grid grid-cols-12 gap-3 lg:gap-10 items-center">
          <motion.div
            className="order-2 col-span-3 sm:col-span-5 lg:col-span-5 relative h-[140px] sm:h-[280px] md:h-[340px] lg:h-[640px] w-full"
          ...
          <div className="order-1 col-span-9 sm:col-span-7 lg:col-span-7">
            ...
            >
              ...
              <h1 className="text-[2.4rem] sm:text-5xl md:text-6xl lg:text-8xl font-serif font-black leading-[0.95] text-foreground mb-4 md:mb-8">
        ...
        <motion.div
          className="mt-5 sm:mt-8 flex flex-row items-stretch gap-3"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
