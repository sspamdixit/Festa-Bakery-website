    ...
    <section className="festa-paper relative overflow-hidden bg-background py-10 md:py-16 lg:py-20">
      <div className="container px-5 mx-auto max-w-5xl">
        <div className="relative grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center rounded-3xl md:rounded-[2.5rem] overflow-hidden shadow-2xl bg-gradient-to-br from-[#fff4d6] via-[#ffe2a6] to-[#ffcf75] [transform:translateZ(0)] isolate">
          ...
          <motion.div
            className="relative z-10 px-6 pt-6 pb-8 md:px-10 md:py-10 lg:py-12 order-2 md:order-1"
          ...
          >
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-serif font-black leading-[0.95] text-foreground mb-4 md:mb-5">
              A 2-minute <span className="italic text-[#d4341f]">Maggi</span> cake. <br className="hidden md:block" />Why not.
            </h2>
            <p className="text-sm md:text-base text-foreground/80 font-sans font-medium leading-relaxed mb-2 md:mb-3 max-w-md">
            ...
            <p className="text-xs md:text-sm text-foreground/70 font-sans font-semibold leading-relaxed max-w-md">
